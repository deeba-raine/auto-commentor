...
app.post('/api/process', async (req, res) => {
    try {
        console.log('API /api/process called');
        ...
        // Save to commented folder with generic name
        const fileInfo = await fileManager.saveCommentedFile('commented_code.js', result.commentedCode);
        
        res.json({
            ...result,
            filename: fileInfo.filename,
            message: 'File saved as: ' + fileInfo.filename
        });
    } catch (error) {
